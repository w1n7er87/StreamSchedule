...
internal class Talk : Command
{
    ...
    public override string Help => $"{(Muted ? " muted " : "")}have a chat a with real frontier AGI (t temp, as chatter, c context {Inference.minContext} - {Inference.maxContext}, l ask nicely for a longer message. ) current model {Model.DimensionCount:NO} params ";
